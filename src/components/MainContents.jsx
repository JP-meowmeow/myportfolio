...
const MainContents = () => {
  ...
  return (
    ...
    <div className="text-white font-kanit overflow-x-hidden bg-gray-50">
      ...
      <nav className="absolute px-10 -mt-20 top-0 left-0 w-full h-[200px]">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex text-xl gap-6 items-center ">
...
>
<button className="btn btn-lg    text-lg font-bold  bg-gradient-to-r from-blue-500  to-green-500 tracking-widest hover:text-black text-white">
            Resume
          </button>
</a>
        ...
        <div className="max-w-7xl mx-auto px-4 pt-20 py-5 sm:py-0">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="max-w-xl">
              ...
              <h1 className="w-[800px] h-[250px] text-5xl md:text-8xl font-bold mb-4 bg-gradient-to-r from-blue-500  to-green-500 bg-clip-text text-transparent">
                Jirapat <br />
                Thongbenjawat
              </h1>
              <div className="-mt-[50px] text-2xl md:text-3xl text-blue-500 font-bold mb-4">
                <span>
            ...
            <div className="w-[px] h-[800px] overflow-hidden ">
              <img
